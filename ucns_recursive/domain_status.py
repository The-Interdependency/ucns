"""Compatibility wrapper for :mod:`ucns.domain_status`.

The implementation moved to ``ucns.domain_status``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.domain_status")
