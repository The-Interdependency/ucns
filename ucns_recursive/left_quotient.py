"""Compatibility wrapper for :mod:`ucns.left_quotient`.

The implementation moved to ``ucns.left_quotient``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.left_quotient")
