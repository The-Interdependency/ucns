"""Compatibility wrapper for :mod:`ucns.witness_matrix`.

The implementation moved to ``ucns.witness_matrix``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.witness_matrix")
