"""Compatibility wrapper for :mod:`ucns.factor_search_v08`.

The implementation moved to ``ucns.factor_search_v08``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.factor_search_v08")
