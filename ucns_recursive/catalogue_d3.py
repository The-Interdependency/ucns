"""Compatibility wrapper for :mod:`ucns.catalogue_d3`.

The implementation moved to ``ucns.catalogue_d3``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.catalogue_d3")
