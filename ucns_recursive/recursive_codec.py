"""Compatibility wrapper for :mod:`ucns.recursive_codec`.

The implementation moved to ``ucns.recursive_codec``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.recursive_codec")
