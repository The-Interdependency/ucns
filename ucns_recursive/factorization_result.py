"""Compatibility wrapper for :mod:`ucns.factorization_result`.

The implementation moved to ``ucns.factorization_result``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.factorization_result")
