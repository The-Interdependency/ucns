...
**Scope:** current implemented directed-cover comparison candidate. It is not the EDCM target carrier unless it integrates the required Möbius causal chain, superpositioned Structural Null, and new-gonol initiation twist. See [`CANON.md`](../CANON.md) for the current geometry-only boundary.
