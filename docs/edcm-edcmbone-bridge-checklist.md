...
## 6) Prime quartet discontinuity note

Cross-repo inclusion across `ucns`, `edcmbone`, `a0`, and `interdependent-lib`
does not constitute theorem transfer. See `docs/prime-quartet-discontinuity.md`.
