"""Compatibility wrapper for :mod:`ucns.canonical_factorization`.

The implementation moved to ``ucns.canonical_factorization``; this module remains so legacy
``ucns_recursive`` imports continue to work during the deprecation window.
"""

from importlib import import_module as _import_module

_module = _import_module("ucns.canonical_factorization")
