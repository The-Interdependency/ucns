...
The repository's Codex assignments are partitioned into ordered files under [`codex-handoff/`](./codex-handoff/) so each package remains independently reviewable. **Read the root index and every file belonging to the active assignment before editing code.**
