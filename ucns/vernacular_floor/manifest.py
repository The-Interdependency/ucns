# === RATIOS ===
# loc_comments: hmmm
# unresolved: word_membership_rule, affix_type_system, twist_fiber_action, homology_template, upstream_a0_betatest_checkout_path
# === END RATIOS ===
...
#   public_surface: load_floor, build_floor, FloorGonol, floor_manifest
#   internal_surface: oewn_ingest, relation_graph, angular_assignment, codebook_import, a0_public_gonol, glyph_axes, floor_build
#   auth_boundary: none
#   storage_boundary: write
#   network_boundary: external
#   user_data_boundary: none
#   admin_only: false
#   tests: ucns.vernacular_floor.tests
#   rollout: hmmm
